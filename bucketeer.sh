...
check_prefix() {
  ...
  test_bucket "$bucket_part-stage.s3.$NAME"
  test_bucket "$bucket_part-stage.s3.$NAME.com"
  test_bucket "$bucket_part-stage-$NAME"
  test_bucket "$bucket_part-stage-$NAME.com"
  test_bucket "$bucket_part-stage-s3-$NAME"
  test_bucket "$bucket_part-stage-s3-$NAME.com"
  test_bucket "$bucket_part-stage-s3.$NAME"
  test_bucket "$bucket_part-stage-s3.$NAME.com"
  test_bucket "$bucket_part.stage.$NAME.com"
  test_bucket "$bucket_part-staging.s3.$NAME"
  test_bucket "$bucket_part-staging.s3.$NAME.com"
  test_bucket "$bucket_part-staging-$NAME"
  test_bucket "$bucket_part-staging-$NAME.com"
  test_bucket "$bucket_part-staging-s3-$NAME"
  test_bucket "$bucket_part-staging-s3-$NAME.com"
  test_bucket "$bucket_part-staging-s3.$NAME"
  test_bucket "$bucket_part-staging-s3.$NAME.com"
